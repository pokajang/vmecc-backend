...
use App\Http\Controllers\InspectionFireExtinguisherIssueController;
...
Route::middleware(['session.auth', 'session.csrf', 'system.maintenance'])->group(function () {
    ...
    Route::post('inspection/fire-extinguishers/{extinguisherId}/out-of-service', [InspectionFireExtinguisherController::class, 'outOfService']);
    Route::post('inspection/fire-extinguishers/{extinguisherId}/return-to-service', [InspectionFireExtinguisherController::class, 'returnToService']);
    Route::post('inspection/fire-extinguishers/{extinguisherId}/retire', [InspectionFireExtinguisherController::class, 'retire']);
    Route::post('inspection/fire-extinguishers/{extinguisherId}/restore', [InspectionFireExtinguisherController::class, 'restore']);
    Route::get('inspection/fire-extinguishers/{extinguisherId}/inspection-history', [InspectionFireExtinguisherController::class, 'inspectionHistory']);
    ...
    Route::post('inspection/fire-extinguisher-issues/{issue}/reopen', [InspectionFireExtinguisherIssueController::class, 'reopen']);
    Route::post('inspection/fire-extinguisher-issues/{issue}/cancel', [InspectionFireExtinguisherIssueController::class, 'cancel']);
    ...
    Route::delete('inspection/fire-trucks/{truckId}', [InspectionFireTruckController::class, 'destroy']);
    Route::get('inspection/scba-catalog', [InspectionScbaCatalogController::class, 'index']);
    Route::post('inspection/scba-catalog/sections', [InspectionScbaCatalogController::class, 'storeSection']);
    Route::patch('inspection/scba-catalog/sections/{sectionId}', [InspectionScbaCatalogController::class, 'updateSection']);
    Route::delete('inspection/scba-catalog/sections/{sectionId}', [InspectionScbaCatalogController::class, 'destroySection']);
    Route::post('inspection/scba-catalog/sections/{sectionId}/items', [InspectionScbaCatalogController::class, 'storeItem']);
    Route::patch('inspection/scba-catalog/items/{itemId}', [InspectionScbaCatalogController::class, 'updateItem']);
    Route::delete('inspection/scba-catalog/items/{itemId}', [InspectionScbaCatalogController::class, 'destroyItem']);
