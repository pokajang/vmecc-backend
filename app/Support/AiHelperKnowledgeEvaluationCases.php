    ...
    public static function core(): array
    {
        return [
            ...
            [
                ...
                'question' => 'How can the VMM site be accessed, where is it located, how large is it, and what area does the emergency response service cover?',
                'response_language' => 'en',
                ...
                'answer_tokens' => ['Teluk Rubiah', 'Jalan Semarak Api'],
                'answer_any_tokens' => [['1196 acres', '1,196 acres']],
            ],
            [
                'id' => 'sow_er_trt_staffing',
                'question' => 'For the emergency response service, what positions and quantities are required per shift, how many TRT members are required in total, and what operating coverage schedule is required?',
                'response_language' => 'en',
                'titles' => ['SOW ER Service 2023-2024 - Sanitized Operational Edition'],
                'expected_topic_key' => 'emergency_response_service',
                'expected_source_type' => AiHelperKnowledgeEntry::KNOWLEDGE_REFERENCE_DOCUMENT,
            ...
            [
                'id' => 'sow_er_trt_member_responsibilities',
                'question' => 'What is the role of a TRT member?',
                'response_language' => 'en',
                'titles' => ['SOW ER Service 2023-2024 - Sanitized Operational Edition'],
                'expected_topic_key' => 'emergency_response_role',
                'expected_source_type' => AiHelperKnowledgeEntry::KNOWLEDGE_REFERENCE_DOCUMENT,
                'evidence_tokens' => [
                    'TACTICAL RESPONSE TEAM MEMBER',
                    'Familiarize with the shift roster',
                    'Conduct inspections on emergency response tools',
                    'Perform emergency response under command of On Scene Commander',
                ],
                'answer_tokens' => ['TRT', 'shift roster', 'inspections', 'On Scene Commander'],
                'answer_forbidden_patterns' => ['Training Review Team'],
            ],
        ];
    }
