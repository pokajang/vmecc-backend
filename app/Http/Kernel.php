...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'permission.assignment' => PermissionAssignmentMiddleware::class,
        'permission.assignment.scope' => PermissionAssignmentScopeMiddleware::class,
        'module.enabled' => EnsureModuleEnabled::class,
        'session.csrf' => VerifySessionCsrfToken::class,
        'system.maintenance' => SystemMaintenanceMiddleware::class,
    ];
}
