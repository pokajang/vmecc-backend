...
class AiHelperTopicAliasRegistry
{
    ...
    private const TOPICS = [
        ...
        'emergency_response_role' => [
            ...
            'incident controller',
            'bert',
            'back-up emergency response team member',
            'backup emergency response team member',
            'anggota pasukan tindak balas',
            'anggota tindak balas kecemasan',
            'komander di tempat kejadian',
            'pengawal insiden',
        ],
