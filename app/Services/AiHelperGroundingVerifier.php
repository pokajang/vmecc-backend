...
class AiHelperGroundingVerifier
{
    ...
    public function verify(
        ...
        $evidence = collect($guidance)->map(fn (array $item) => [
            ...
            'task_keys' => array_values((array) ($item['task_keys'] ?? [])),
