...
class AiHelperSystemGuideCatalog
{
    ...
    private const GUIDES = [
        ...
        'payment-actions' => ['module_key' => 'payroll', 'route_key' => 'salary-claims', 'module_gate' => 'payroll.payment_actions', 'permissions' => ['staff.salary.pay'], 'owner' => 'Finance', 'tasks' => ['payroll.payment.manage'], 'entities' => ['payment']],
        ...
        'erco-reports' => ['module_key' => 'reports', 'route_key' => 'erco', 'module_gate' => 'reports.erco', 'permissions' => ['reports.erco.view'], 'owner' => 'Operations', 'tasks' => ['reports.erco.manage'], 'entities' => ['erco']],
        'drill-reports' => ['module_key' => 'reports', 'route_key' => 'drill', 'module_gate' => 'reports.drill', 'permissions' => ['reports.drill.view'], 'owner' => 'Operations', 'tasks' => ['reports.drill.manage'], 'entities' => ['drill']],
        'fitness-reports' => ['module_key' => 'reports', 'route_key' => 'fitness', 'module_gate' => 'reports.fitness_test', 'permissions' => ['reports.fitness.view'], 'owner' => 'Operations', 'tasks' => ['reports.fitness.manage'], 'entities' => ['fitness']],
        'report-management' => ['module_key' => 'reports', 'route_key' => 'reports', 'module_gate' => 'reports', 'permissions' => ['reports.manage'], 'owner' => 'Operations', 'tasks' => ['reports.review'], 'entities' => ['report_management']],
