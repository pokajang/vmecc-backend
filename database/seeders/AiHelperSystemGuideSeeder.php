...
class AiHelperSystemGuideSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $approvals = app(AiHelperSystemGuideApprovalManifest::class);
        ...
        foreach ($parsedGuides as $key => ['file' => $file, 'parsed' => $parsed, 'metadata' => $metadata]) {
            ...
            $expectedReviewStatus = $metadata['release_status'] === AiHelperSystemGuideCatalog::RELEASE_APPROVED
                ? AiHelperKnowledgeEntry::REVIEW_APPROVED
                : AiHelperKnowledgeEntry::REVIEW_PENDING;
            ...
            $unchanged = $entry->exists
                && hash_equals((string) $entry->content_hash, $approvals->contentHash($content))
            ...
            $entry->forceFill([
                ...
                'review_status' => $metadata['release_status'] === AiHelperSystemGuideCatalog::RELEASE_APPROVED
                    ? AiHelperKnowledgeEntry::REVIEW_APPROVED
                    : AiHelperKnowledgeEntry::REVIEW_PENDING,
                'reviewed_by' => null,
                'reviewed_at' => $metadata['release_status'] === AiHelperSystemGuideCatalog::RELEASE_APPROVED
                    ? $metadata['reviewed_on']
                    : null,
                'review_note' => null,
