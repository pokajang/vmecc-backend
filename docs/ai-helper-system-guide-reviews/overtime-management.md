...
1. Frontend route/guard: Open /staff/overtime-management/records and /staff/overtime-management/record/:overtimeRouteKey.
...
4. Controller/request: `vmecc-frontend/src/views/staff/overtime-management/OvertimeManagement.js`; `vmecc-backend/app/Http/Controllers/OvertimeWorkflowController.php`; `vmecc-backend/app/Services/OvertimeWorkflowService.php`.
...
8. Workflow/next actors: Pending advances review â†’ optional recommend â†’ approve â†’ Approved; correction, rejection, and cancellation stop the path.
